                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="py-4 px-6 text-right">
                        ...
                        <form method="POST" class="inline-block m-0 p-0">
                            ...
                            <button type="submit" name="action" value="revoke" class="text-orange-500 hover:text-orange-700 mx-1 p-1 tooltip" title="Revoke Approval"><i class="fas fa-ban"></i></button>
                        </form>
                    </td>
                </tr>
                <?php endforeach; ?>

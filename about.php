    ...
    <div class="container mx-auto px-4 max-w-6xl">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div data-aos="fade-left">
                <h2 class="text-3xl md:text-4xl font-bold text-dark mb-4">Welcome to Jain Digambar Matrimony</h2>
                <div class="w-16 h-1 bg-primary mb-6"></div>

                <p class="text-gray-600 mb-4 leading-relaxed text-lg">We understand that in the Digambar Jain community,
                    marriage is not just the union of two individuals, but the coming together of two families, their
                    values, and their devotion to Jain principles.</p>

                <p class="text-gray-600 mb-4 leading-relaxed">Our exclusive platform is tailored specifically for
                    Digambar Jains (including Khandelwal, Agarwal, Porwal, Parwar, and other sub-sects). We provide a
                    secure, trusted, and highly verified environment where you can seek a life partner who strictly
                    adheres to vegetarianism, ethical living, and our rich spiritual heritage.</p>

                <p class="text-gray-600 leading-relaxed">Unlike generic matrimonial websites, we filter profiles
                    specifically based on Jain gotras, astrological compatibility (Kundali / Manglik checks), and
                    religious beliefs, ensuring you find a match that truly aligns with your family's expectations.</p>
            </div>
        </div>
    </div>
</section>
